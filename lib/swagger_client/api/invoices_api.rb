...
module SwaggerClient
  class InvoicesApi
    ...
    def invoices_get_by_id(id, opts = {})
      data, _status_code, _headers = invoices_get_by_id_with_http_info(id, opts)
      return data
    end
    ...
    def invoices_get_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.invoices_get_by_id ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.invoices_get_by_id"
      end
      # resource path
      local_var_path = "/api/Invoices/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#invoices_get_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [InvoiceDetails]
    def invoices_get_by_number(number, opts = {})
      data, _status_code, _headers = invoices_get_by_number_with_http_info(number, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InvoiceDetails, Fixnum, Hash)>] InvoiceDetails data, response status code and response headers
    def invoices_get_by_number_with_http_info(number, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && number.nil?
        fail ArgumentError, "Missing the required parameter 'number' when calling InvoicesApi.invoices_get_by_number"
      end
      # resource path
      local_var_path = "/api/Invoices"
