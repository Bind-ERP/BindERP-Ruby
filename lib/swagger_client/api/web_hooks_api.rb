...
module SwaggerClient
  class WebHooksApi
    ...
    # @return [Object]
    def web_hooks_add_web_hook_subscriptions(web_hook_subscription, opts = {})
      data, _status_code, _headers = web_hooks_add_web_hook_subscriptions_with_http_info(web_hook_subscription, opts)
      return data
    end
    ...
    def web_hooks_add_web_hook_subscriptions_with_http_info(web_hook_subscription, opts = {})
      ...
      if @api_client.config.client_side_validation && web_hook_subscription.nil?
        fail ArgumentError, "Missing the required parameter 'web_hook_subscription' when calling WebHooksApi.web_hooks_add_web_hook_subscriptions"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def web_hooks_delete_web_hook_subscriptio_by_id(id, opts = {})
      web_hooks_delete_web_hook_subscriptio_by_id_with_http_info(id, opts)
      return nil
    end
    ...
    def web_hooks_delete_web_hook_subscriptio_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: WebHooksApi.web_hooks_delete_web_hook_subscriptio_by_id ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WebHooksApi.web_hooks_delete_web_hook_subscriptio_by_id"
      end
      # resource path
      local_var_path = "/api/WebHookSubscriptions"
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebHooksApi#web_hooks_delete_web_hook_subscriptio_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
