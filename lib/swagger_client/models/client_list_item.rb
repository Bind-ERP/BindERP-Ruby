...
module SwaggerClient
  ...
  class ClientListItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'NextContactDate')
        self.next_contact_date = attributes[:'NextContactDate']
      end
    ...
    def hash
      [id, number, client_name, legal_name, rfc, email, phone, city, next_contact_date].hash
    end
