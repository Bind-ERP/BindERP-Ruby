...
module SwaggerClient
  ...
  class UserProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'CompanyNumber')
        self.company_number = attributes[:'CompanyNumber']
      end
    ...
    def hash
      [company_id, company_name, company_number, email, name, rfc, roles, user_id, username].hash
    end
