...
module SwaggerClient
  ...
  class NewOrder
    ...
    def hash
      [address_id, client_id, comments, currency_id, discount_amount, discount_type, doc_number_id, exchange_rate, isr_rate, location_id, order_date, price_list_id, purchase_order, vat_rate, vat_ret_rate, warehouse_id, emails, products, services].hash
    end
