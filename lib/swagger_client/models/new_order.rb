...
module SwaggerClient
  ...
  class NewOrder
    ...
    def hash
      [address_id, client_id, currency_id, location_id, order_date, price_list_id, warehouse_id, comments, discount_amount, discount_type, doc_number_id, exchange_rate, isr_rate, purchase_order, vat_rate, vat_ret_rate, emails, products, services].hash
    end
