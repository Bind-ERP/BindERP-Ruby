...
module SwaggerClient
  ...
  class NewPayment
    ...
    attr_accessor :exchange_rate_account
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ExchangeRateAccount')
        self.exchange_rate_account = attributes[:'ExchangeRateAccount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          exchange_rate_account == o.exchange_rate_account
    end
    ...
    def hash
      [invoice_id, account_id, date, reference, amount, payment_term, comments, exchange_rate, exchange_rate_account].hash
    end
