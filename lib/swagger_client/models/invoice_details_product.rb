...
module SwaggerClient
  ...
  class InvoiceDetailsProduct
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LotInfo')
        self.lot_info = attributes[:'LotInfo']
      end
    ...
    def hash
      [product_id, name, index_number, code, unit, unit_multiplier, qty, price, vat_rate, ieps_rate, discount, comments, lot_info].hash
    end
