...
module SwaggerClient
  ...
  class NewActivity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RepeatType')
        self.repeat_type = attributes[:'RepeatType']
      end

      if attributes.has_key?(:'Repetitions')
      ...
      if attributes.has_key?(:'ExternalIDType')
        self.external_id_type = attributes[:'ExternalIDType']
      end
    ...
    def list_invalid_properties
      ...
      if @repeatable.nil?
        invalid_properties.push("invalid value for 'repeatable', repeatable cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @repeatable.nil?
      return true
    end
    ...
    def hash
      [comment, start_date, end_date, event_type, is_public, title, repeatable, repeat_interval, repeat_type, repetitions, external_id, external_id_type].hash
    end
