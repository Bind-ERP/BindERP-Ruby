...
module SwaggerClient
  ...
  class EditProduct
    ...
    def hash
      [id, code, title, cost, currency_id, exchange_rate, sku, description, cost_type, category1_id, category2_id, category3_id, charge_vat, number, pricing_type, unit, purchase_type, ieps_rate, type, production_auto].hash
    end
