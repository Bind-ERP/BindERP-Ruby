...
module SwaggerClient
  ...
  class EditClient
    ...
    def hash
      [id, legal_name, commercial_name, rfc, credit_days, credit_amount, price_list_id, accounting_number, payment_method, payment_term, location_id, sales_employee_id, credit_employee_id, comment, telephone, email, account_number, default_discount, source].hash
    end
