...
module SwaggerClient
  ...
  class OrderDetailsProduct
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'UnitMultiplier')
        self.unit_multiplier = attributes[:'UnitMultiplier']
      end
      ...
      if attributes.has_key?(:'QtyFullFilled')
        self.qty_full_filled = attributes[:'QtyFullFilled']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          code == o.code &&
          unit == o.unit &&
          unit_multiplier == o.unit_multiplier &&
          qty == o.qty &&
          price == o.price &&
          ieps_rate == o.ieps_rate &&
          comments == o.comments &&
          qty_full_filled == o.qty_full_filled &&
          vat_rate == o.vat_rate
    end
    ...
    def hash
      [product_id, name, index_number, code, unit, unit_multiplier, qty, price, ieps_rate, comments, qty_full_filled, vat_rate].hash
    end
