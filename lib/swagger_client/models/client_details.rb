...
module SwaggerClient
  ...
  class ClientDetails
    ...
    def hash
      [id, rfc, legal_name, commercial_name, credit_days, credit_amount, payment_method, creation_date, status, sales_contact, credit_contact, loctaion, comments, price_list, payment_term_type, email, telephones, number, account_number, default_discount, client_source, account].hash
    end
