...
# Unit tests for SwaggerClient::WebHookSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebHookSubscription' do
  before do
    # run before each test
    @instance = SwaggerClient::WebHookSubscription.new
  end
  ...
  describe 'test an instance of WebHookSubscription' do
    it 'should create an instance of WebHookSubscription' do
      expect(@instance).to be_instance_of(SwaggerClient::WebHookSubscription)
    end
  end
