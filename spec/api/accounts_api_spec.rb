...
describe 'AccountsApi' do
  ...
  # unit tests for accounts_add_client
  # Agregar Cuenta Contable
  # 
  # @param new_account 
  # @param [Hash] opts the optional parameters
  # @return [String]
  describe 'accounts_add_client test' do
    it "should work" do
  ...
  # unit tests for accounts_get_price_lists
  ...
  # @return [AccountPage]
  describe 'accounts_get_price_lists test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
